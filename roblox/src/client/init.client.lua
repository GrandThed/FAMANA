...
local TerritoryUI = require(script:WaitForChild("TerritoryUI"))
local PartyUI = require(script:WaitForChild("PartyUI"))
local GuildUI = require(script:WaitForChild("GuildUI"))
local GuildBankUI = require(script:WaitForChild("GuildBankUI"))
...
local GuildResearchUI = require(script:WaitForChild("GuildResearchUI"))
